...
K1 и K2 — количество купонов, которые останутся неиспользованными у Пети после этих N дней и количество использованных им купонов соответственно.
...
CouponesStrategy = namedtuple('CouponesStrategy', ['min_sum', 'unused_coupones_count', 'used_coupones_count', 'coupone_days'])


def calculate_coupones_strategy(N, prices):
    min_sum = 235
    unused_coupones_count = 0
    used_coupones_count = 1
    coupone_days = [5]
    return CouponesStrategy(min_sum, unused_coupones_count, used_coupones_count, coupone_days)
...
def main():
    ...
    strategy = calculate_coupones_strategy(N, prices)
    print(strategy.min_sum)
    print(strategy.unused_coupones_count, strategy.used_coupones_count)
    for day in strategy.coupone_days:
        print(day)
